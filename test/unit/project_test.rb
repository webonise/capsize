...
class ProjectTest < ActiveSupport::TestCase
  ...
  def test_default_config
    ...
    # from BASE
    assert_not_nil p.configuration_parameters.find_by_name('user')
    assert_not_nil p.configuration_parameters.find_by_name('scm')

    # from RAILS
    assert_not_nil p.configuration_parameters.find_by_name('rails_env')

    # check that symbols arrive ok
    assert_equal ':git', p.configuration_parameters.find_by_name('scm').value
